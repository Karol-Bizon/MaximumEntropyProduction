...
parameters = {'index of profile': 1,
              ...
              # 'initial value':  [np.ones(21), (0.18 * np.ones(20)), np.ones(20)],

              'positive entropy production': 'Yes',  # 'Yes' generally helps, not always
...
#      },
#     {'physical model': 'wc_sa', 'optimization variable': 'xmf', 'initial value': [1, 0.2, 0.1],
#                  'positive entropy production': 'Yes', 'maximal mass': 0.33, 'coefficient multiplication': 0.1,
#                  'model name': "local max"
#      }
#                          ]

# # plot for different CO2 configurations
# list_model_to_compare = [
#     {"CO2": 180.0, "linearisation of radiative flux": "once per resolution iteration", "optimization variable": "x",
#      "optimization variable to initialize": "x", "physical model": "un",
#      "initial value": [1], "positive entropy production": "No", "model name": "un - 180 ppm"
#      },
#     {"CO2": 280.0, "linearisation of radiative flux": "once per resolution iteration", "optimization variable": "x",
#      "optimization variable to initialize": "x", "physical model": "un",
#      "initial value": [1], "positive entropy production": "No", "model name": "un - 280 ppm"
#      },
#     {"CO2": 560.0, "linearisation of radiative flux": "once per resolution iteration", "optimization variable": "x",
#      "optimization variable to initialize": "x", "physical model": "un",
#      "initial value": [1], "positive entropy production": "No", "model name": "un - 560 ppm"
#      },
#
#     {"CO2": 180.0, "linearisation of radiative flux": "no linearisation", "optimization variable": "x",
#      "optimization variable to initialize": "x", "physical model": "ini moist",
#      "initial value": [1], "positive entropy production": "No", "model name": "ini moist - 180 ppm"
#      },
#     {"CO2": 280.0, "linearisation of radiative flux": "no linearisation", "optimization variable": "x",
#      "optimization variable to initialize": "x", "physical model": "ini moist",
#      "initial value": [1], "positive entropy production": "No", "model name": "ini moist - 280 ppm"
#      },
#     {"CO2": 560.0, "linearisation of radiative flux": "no linearisation", "optimization variable": "x",
#      "optimization variable to initialize": "x", "physical model": "ini moist",
#      "initial value": [1], "positive entropy production": "No", "model name": "ini moist - 560 ppm"
#      },
#
#     {"CO2": 180.0, "linearisation of radiative flux": "once per resolution iteration", "optimization variable": "xmf",
#      "optimization variable to initialize": "xmf", "physical model": "wc",
#      "initial value": [1, 0.2, 1], "positive entropy production": "No", "model name": "wc - 180 ppm"
#      },
#     {"CO2": 280.0, "linearisation of radiative flux": "once per resolution iteration", "optimization variable": "xmf",
#      "optimization variable to initialize": "xmf", "physical model": "wc",
#      "initial value": [1, 0.2, 1], "positive entropy production": "Yes", "model name": "wc - 280 ppm"
#      },
#     {"CO2": 560.0, "linearisation of radiative flux": "once per resolution iteration", "optimization variable": "xmf",
#      "optimization variable to initialize": "xmf", "physical model": "wc",
#      "initial value": [1, 0.18, 0.09], "positive entropy production": "No", "model name": "wc - 560 ppm"
#      }
# ]
