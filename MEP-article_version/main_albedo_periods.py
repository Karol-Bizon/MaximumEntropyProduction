...
parameters = {
    ...
    "results subfolder": "period_runs/alb",
...
list_model_to_compare = [{"albedo": albedo, "model name": f"{label}_alb{albedo:.2f}"} for label, albedo in period_albedo]
...
print("\n=== Albedo period scenarios summary (robust mode, CO2 fixed at 420 ppm) ===")
