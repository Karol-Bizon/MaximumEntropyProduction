# -*- coding: utf-8 -*-
"""
CO2 sensitivity for a simplified Earth-like climate setup.
...
parameters = {
    ...
    "maxiter of the minimize function": 3000,
    "resolution method": "threshold",
    "max number of iterations": 50,
    "variation threshold": 10 ** -10,
    "print option": True,
    "save option": True,
    "save to excel option": True,
    "file name": "co2",
    "compact file naming option": True,
    "results subfolder": "period_runs/co2",
...
list_model_to_compare = [
    {"CO2": co2_ppm, "model name": f"{label}_{int(co2_ppm)}ppm"}
...
# Optional save and export from merged robust results
...
print("\n=== CO2 period scenarios summary (robust mode) ===")
